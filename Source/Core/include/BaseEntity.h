...
namespace Core
{
    ...
    protected:
        ...
        BaseEntity* mParent { nullptr };

        /* Дочерние сущности */
        std::vector<BaseEntity*> mChildren;
    ...
    public:
         ...
         * @param name имя узла
         */
        BaseEntity(const std::string& name = "Root");
         ...
         */
        inline void SetParent(BaseEntity* parent)
        {
            mParent = parent;
        }
         ...
         */
        inline BaseEntity* GetParent() const
        {
            return mParent;
        }
         ...
         */
        void LinkChild(BaseEntity* pChild);
         ...
         * @param child указатель на дочернюю сущность
         */
        void LinkChildByIndex(uint32_t index, BaseEntity* pChild);
         ...
         */
        void UnlinkParent(BaseEntity* pChild);
         ...
         */
        void UnlinkChild(BaseEntity* pChild);
         ...
         */
        size_t GetChildIndex(BaseEntity* pChild);
         ...
         */
        BaseEntity* FindChildByName(const std::string& name);
         ...
         */
        inline void SetHandle(BaseEntity* pHandle)
        {
            mHandle = pHandle;
        }
         ...
         */
        inline BaseEntity* GetHandle() const
        {
            return mHandle;
        }
